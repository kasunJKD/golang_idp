...
type TokenServiceClient interface {
	...
	NewAuthCodeGrant(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
	VerifyAuthCodeToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error)
	NewAuthCodeRefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*AuthCodeToken, error)
	AuthCodeRefreshTokenExists(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error)
	AddUserIdAuthCodeFlow(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error)
	GetUserIdfromAccesstoken(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
...
func (c *tokenServiceClient) NewAuthCodeGrant(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
...
func (c *tokenServiceClient) VerifyAuthCodeToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
...
func (c *tokenServiceClient) AuthCodeRefreshTokenExists(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
	out := new(wrapperspb.BoolValue)
...
func (c *tokenServiceClient) AddUserIdAuthCodeFlow(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
	out := new(wrapperspb.BoolValue)
...
func (c *tokenServiceClient) GetUserIdfromAccesstoken(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	out := new(wrapperspb.StringValue)
...
type TokenServiceServer interface {
	...
	NewAuthCodeGrant(context.Context, *TokenRequest) (*wrapperspb.StringValue, error)
	VerifyAuthCodeToken(context.Context, *TokenRequest) (*wrapperspb.BoolValue, error)
	NewAuthCodeRefreshToken(context.Context, *RefreshTokenRequest) (*AuthCodeToken, error)
	AuthCodeRefreshTokenExists(context.Context, *RefreshTokenRequest) (*wrapperspb.BoolValue, error)
	AddUserIdAuthCodeFlow(context.Context, *User) (*wrapperspb.BoolValue, error)
	GetUserIdfromAccesstoken(context.Context, *User) (*wrapperspb.StringValue, error)
...
func (UnimplementedTokenServiceServer) NewAuthCodeGrant(context.Context, *TokenRequest) (*wrapperspb.StringValue, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewAuthCodeGrant not implemented")
}
func (UnimplementedTokenServiceServer) VerifyAuthCodeToken(context.Context, *TokenRequest) (*wrapperspb.BoolValue, error) {
...
func (UnimplementedTokenServiceServer) AuthCodeRefreshTokenExists(context.Context, *RefreshTokenRequest) (*wrapperspb.BoolValue, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthCodeRefreshTokenExists not implemented")
}
func (UnimplementedTokenServiceServer) AddUserIdAuthCodeFlow(context.Context, *User) (*wrapperspb.BoolValue, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddUserIdAuthCodeFlow not implemented")
}
func (UnimplementedTokenServiceServer) GetUserIdfromAccesstoken(context.Context, *User) (*wrapperspb.StringValue, error) {
